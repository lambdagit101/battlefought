...
function DrawHealthDisplay()
    ...
    draw.DrawText(string.format(language.GetPhrase("bftui-hud-armorcharges"), LocalPlayer():GetAmmoCount("armor_charge")), "bfthud_general_blur", (ScrW() * 130 / 1920) + GetConVar("bfthud_xoffset"):GetInt() + boxsizex * 0.735 + 2, ScrH() - boxsizey / 2 - (ScrH() * 60 / 1080) - GetConVar("bfthud_yoffset"):GetInt() + (ScrH() * 4 / 1080) + 2, hudbgcolor, TEXT_ALIGN_CENTER)
    draw.DrawText(string.format(language.GetPhrase("bftui-hud-armorcharges"), LocalPlayer():GetAmmoCount("armor_charge")), "bfthud_general", (ScrW() * 130 / 1920) + GetConVar("bfthud_xoffset"):GetInt() + boxsizex * 0.735, ScrH() - boxsizey / 2 - (ScrH() * 60 / 1080) - GetConVar("bfthud_yoffset"):GetInt() + (ScrH() * 4 / 1080), hudtxcolor, TEXT_ALIGN_CENTER)
...
function DrawAmmo()
    ...
    -- Don't draw the ammo counter if it's already displayed above
