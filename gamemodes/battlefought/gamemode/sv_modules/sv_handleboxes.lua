...
function GM:PostCleanupMap()
    ...
    if boxPositions == nil then
        print("battle_fought_err_:> There are no supply box locations available! Please create some by going into Sandbox and using the battle_fought_boxer_ weapon in the Other category. Left click saves a box, right click saves the file for the map it's being used in.")
    end
